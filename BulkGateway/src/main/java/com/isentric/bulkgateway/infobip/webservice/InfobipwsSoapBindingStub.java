...
public class InfobipwsSoapBindingStub extends Stub implements InfobipDipInterface {
    ...
    private static void _initOperationDesc1() {
        ...
        oper.setReturnType(new QName("http://webservice.tga.bg.isentric.com", "QSResponse"));
        oper.setReturnClass(QSResponse.class);
        oper.setReturnQName(new QName("", "InfobipDippingReturn"));
        oper.setStyle(Style.RPC);
        oper.setUse(Use.ENCODED);
        _operations[0] = oper;
        oper = new OperationDesc();
        oper.setName("InfobipDippingSkipFilter");
        ...
        oper.setReturnType(new QName("http://webservice.tga.bg.isentric.com", "QSResponse"));
        oper.setReturnClass(QSResponse.class);
        oper.setReturnQName(new QName("", "InfobipDippingSkipFilterReturn"));
        oper.setStyle(Style.RPC);
        oper.setUse(Use.ENCODED);
        _operations[1] = oper;
    }

    public InfobipwsSoapBindingStub() throws AxisFault {
        this((Service)null);
    }

    public InfobipwsSoapBindingStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public InfobipwsSoapBindingStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://webservice.tga.bg.isentric.com", "QSResponse");
    ...
    public QSResponse InfobipDipping(String in0) throws RemoteException {
        if (super.cachedEndpoint == null) {
            ...
            _call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
            _call.setOperationName(new QName("urn:webservice.Infobip.bg.isentric.com", "InfobipDipping"));
    ...
    public QSResponse InfobipDippingSkipFilter(String in0) throws RemoteException {
        if (super.cachedEndpoint == null) {
            ...
            _call.setSOAPActionURI("");
            _call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
            _call.setOperationName(new QName("urn:webservice.Infobip.bg.isentric.com", "InfobipDippingSkipFilter"));
            this.setRequestHeaders(_call);
            this.setAttachments(_call);
