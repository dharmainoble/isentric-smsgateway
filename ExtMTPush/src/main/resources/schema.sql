-- ExtMTPush Database Schema
-- This file creates all required tables for the ExtMTPush application
...
INSERT INTO bulk_credit (custid, credit, credit_type, password, status) VALUES
('TEST001', 1000.00, 1, 'test123', 1),
('TEST002', 500.00, 1, 'test456', 1),
('UNLIMITED', 0.00, -1, 'unlimited', 1);

INSERT INTO bulk_masking_id (custid, masking_id, status) VALUES
('TEST001', 'SENDER', 1),
('TEST001', 'COMPANY', 1),
('TEST002', 'BRAND', 1);

INSERT INTO bulk_destination_sms (custid, local_flag, int_flag, status) VALUES
('TEST001', '0', '0', 1),
('TEST002', '0', '1', 1),
('UNLIMITED', '0', '0', 1);

INSERT INTO bulk_ip_whitelist (custid, ip_address, status) VALUES
('TEST001', '0.0.0.0', 1),
('TEST002', '127.0.0.1', 1);
...
('SVC001', 'HTTP_CELCOM', 'MSG001', 'MT_STATUS', '12345', '60123456789', CURRENT_TIMESTAMP, 'STATE_DELIVERED', 'DELIVERED', '0', '', CURRENT_TIMESTAMP, ''),
('SVC001', 'HTTP_DIGI', 'MSG002', 'MT_STATUS', '12345', '60163456789', CURRENT_TIMESTAMP, 'STATE_ENROUTE', 'PENDING', '', '', CURRENT_TIMESTAMP, '');
